...
class Trabalhos:
    ...
    def mensagem_inicial(self,lista):
...
if(__name__ == "__main__"):
    ...
    while hercules.vida > 0:
        ...
        if trabalho == 2:
            ...
            opcao = hercules.menu(['Usar a graça dos deuses para comprar madeira e tecido.', 'Usar madeira e tecido para fazer a tocha.', 'Tomar poção de cura', 'Atacar o monstro'])
            if opcao == '1':
                hercules.graca -= 20
                 ...
                 if arma == "1":
                     ...
                     hercules.energia += 10
                      ...
                      if hercules.arma == True:
                       ...
                       break#o erro que ocorreu na aula foi esse break que não foi escrito
        if trabalho == 8:
